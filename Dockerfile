...
RUN /root/Downloads/${INSTALLER_PATH} --mode unattended --unattendedmodeui none --enable-components PF_MSP430 --prefix /opt/ti
RUN mkdir -p /home/build/workspace


FROM ghcr.io/grahame/ccs-base:v20.3.0 AS install-specific-cgt
